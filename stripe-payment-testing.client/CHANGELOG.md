...
- Create Angular project with ng: `ng new stripe-payment-testing.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`stripe-payment-testing.client.esproj`).
